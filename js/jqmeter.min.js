...
!function (e) {
    e.fn.extend({
        ...
        e(t).append("<style>.therm{height:30px;border-radius:5px;}.outer-therm{margin:4px 0;}.inner-therm span {color: #fff;display: inline-block;float: right;font-family: Trebuchet MS;font-size: 18px;font-weight: bold;padding:0 2px !important;}.vertical.inner-therm span{width:100%;text-align:center;}.vertical.outer-therm{position:relative;}.vertical.inner-therm{position:absolute;bottom:0;}</style>")
    }, e.jQMeter.defaults = {
        width: "100%",
        height: "50px",
        bgColor: "#444",
